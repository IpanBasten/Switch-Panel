<x-app-layout>
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <h2 class="text-xl font-semibold text-gray-800 mb-4">Tambah Panel Jaringan Baru</h2>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('panels.store') }}" method="POST">
                    ...
                    <p class="text-sm text-gray-600 mb-4">Tambahkan setidaknya satu perangkat Switch yang terhubung ke Panel ini.</p>
                    ...
                    <div class="flex justify-end">
                        <button type="submit" 
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-md shadow-lg transition duration-150 ease-in-out">
                            Simpan Panel dan Switches
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Jika ada data lama (setelah validasi gagal), gunakan itu. Jika tidak, mulai dari 0.
            const oldSwitches = @json(old('panel_switches', []));
            const dataToLoad = Object.values(oldSwitches);
            ...
            // Muat data lama atau tambahkan minimal 1 input kosong
            if (dataToLoad.length > 0) {
                dataToLoad.forEach(data => addSwitch(data));
            } else {
                addSwitch(); // Tambahkan switch pertama secara default
            }
